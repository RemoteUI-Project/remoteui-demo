...
/**
 * The detail activity and the activity for a new contact of the contacts app
 * are currently only static activities. They were used in a scientific paper to
 * measure the download sizes of their layouts.
 *
